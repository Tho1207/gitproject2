...
<body id="body">
<!-- Reference from https://mdbootstrap.com/docs/standard/extended/registration/ -->
          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="register" method="post">
                ...
                <div class="form-outline mb-4">
                  <input name="user" type="email" id="form3Example3cg" class="form-control form-control-lg" />
                ...
                <div class="d-flex justify-content-center">
                  <button class="btn btn-block btn-lg text-body" type="submit" id="btn">Register</button>
                </div>
