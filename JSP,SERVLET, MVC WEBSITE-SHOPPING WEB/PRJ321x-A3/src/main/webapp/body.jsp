...
<jsp:useBean id="a" class="dao.ListProductDAO" scope="request"></jsp:useBean>
			...
			<c:forEach var="o" items="${products}">
				<div class="col-lg-3 col-md-6 pb-5">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light">
                        ...
                        <a href="addToCart?action=add&id=${o.id}" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                    </div>
				</div>
				...
				<div class="col-4 pb-5">
					<nav>
						<ul class="pagination" id="pag">
						  ...
						  <li class="page-item">
							<a onclick="backward()" class="page-link" href="#" aria-label="Next">
